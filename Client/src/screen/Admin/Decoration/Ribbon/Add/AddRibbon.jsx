...
function AddRibbon() {
    ...
    const [category, setCategory] = useState("Ribbon")
    const [type, setType] = useState("")
    const [image, setImage] = useState("")

    const [AddRibbon] = useAddDecorationMutation()
    ...
    const onAdd = async (e) => {
        e.preventDefault()
        await AddRibbon({name, category, type, price, image})

        navigate('/adminDash/admin/product/ribbon/ribbonList')
    }
